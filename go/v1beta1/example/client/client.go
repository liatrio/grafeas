			...
			AnalysisResults: &static_analysis_go_proto.StaticAnalysis{
				...
				Summary: &static_analysis_go_proto.Stats{
					...
					Reliability: &static_analysis_go_proto.Reliability{
						...
						NewBugs:                         0,
						Rating:                          0,
						NewReliabilityRating:            0,
						RemediationEffort:               0,
						NewReliabilityRemediationEffort: 0,
						Findings:                        nil,
					},
					Security: &static_analysis_go_proto.Security{
						...
						NewSecurityRemediationEffort: 0,
						SecurityHotspots:             0,
						NewSecurityHotspots:          0,
						SecurityReviewRating:         0,
						NewSecurityReviewRating:      0,
						SecurityHotspotsReviewed:     0.0,
						Findings:                     nil,
					},
					...
					QualityGate: &static_analysis_go_proto.QualityGate{
						QualityGateName:    "",
						QualityProfileName: "",
						QualityGateStatus:  "",
						QualityGateDetails: "",
					},
					Tests: &static_analysis_go_proto.Tests{
						ConditionCoverage:       0.0,
						NewConitionCoverage:     0.0,
						ConditionCoverageHits:   "",
						ConditionsByLine:        0,
						CoveredConditionsByLine: 0,
						Coverage:                0.0,
						NewCoverage:             0.0,
						LineCoverage:            0.0,
						NewLineCoverage:         0.0,
